        ...
        >
            <div className="absolute inset-0 flex items-center justify-center">
                <div className="text-center p-6">
                    {/* Heading */}
                    <h1 className="rubik-vinyl-regular text-black text-3xl sm:text-5xl md:text-7xl lg:text-8xl font-semibold mb-6 leading-tight flex items-center justify-center flex-wrap">
                        Give Your Home <br />
                        Some Shine
                        <img
