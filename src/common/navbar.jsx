            ...
            <div className="flex items-center justify-between px-6 md:px-14 py-4">
                ...
                <div className="hidden md:flex items-center justify-center space-x-12 flex-1">
                    <NavLink
                        to="/"
                        className={({ isActive }) =>
                            `text-white text-lg font-medium transition-all ${isActive
                                ? "border-b-2 border-[#ECF8F9] text-[#ECF8F9]"
                                : "hover:text-[#ECF8F9] hover:scale-110"
                            }`
                        }
                    >
                        Home
                ...
                >
                    <img
                        src={isMenuOpen ? assets.back : assets.menu}
                        alt="Menu Icon"
                        className="relative left-16 h-6 w-6"
                    />
                </button>
                <div>
                    <button className="hidden md:block text-white text-lg font-medium transition-all rounded-2xl p-1 px-3 bg-orange-500 hover:scale-110 active:scale-100 ">Hire Now</button>
                </div>
            </div>
